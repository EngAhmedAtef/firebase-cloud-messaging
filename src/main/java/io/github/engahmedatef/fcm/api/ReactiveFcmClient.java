...
public interface ReactiveFcmClient {
     ...
     * @return a {@link Mono} emitting the send result; errors are typed {@link io.github.engahmedatef.fcm.exception.FcmException} subtypes
     */
     ...
     *         {@link io.github.engahmedatef.fcm.exception.FcmBatchExceededThresholdException} if the
     ...
     *         {@link io.github.engahmedatef.fcm.exception.FcmTokenServiceNotDefinedException} if no
