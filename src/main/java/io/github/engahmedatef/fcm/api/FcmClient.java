package io.github.engahmedatef.fcm.api;
...
public interface FcmClient {
     ...
     * @throws io.github.engahmedatef.fcm.exception.FcmInvalidTokenException   if the token is invalid or unregistered
     * @throws io.github.engahmedatef.fcm.exception.FcmAuthenticationException if authentication fails
     * @throws io.github.engahmedatef.fcm.exception.FcmUnavailableException    if FCM is temporarily unavailable
     */
     ...
     * @param message the message payload
     * @throws io.github.engahmedatef.fcm.exception.FcmBatchExceededThresholdException if the failure rate
     ...
     * @param message the message payload
     * @throws io.github.engahmedatef.fcm.exception.FcmTokenServiceNotDefinedException if no
