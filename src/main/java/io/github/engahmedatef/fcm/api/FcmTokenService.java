 ...
 *       {@link io.github.engahmedatef.fcm.exception.FcmInvalidTokenException}.</li>
 * </ul>
 *
 * <p>If no bean is registered, {@code sendToUser()} throws
 * {@link io.github.engahmedatef.fcm.exception.FcmTokenServiceNotDefinedException} and stale token
