...
public class FcmProperties {
    ...
    public static class Send {
        ...
        /**
         * Fraction of failures in a batch window that triggers {@link io.github.engahmedatef.fcm.exception.FcmBatchExceededThresholdException}.
    ...
    public static class Extensibility {
        /** When {@code false}, registered {@link io.github.engahmedatef.fcm.spi.FcmPayloadInterceptor} beans are bypassed. Default: {@code true}. */
        private boolean interceptorsEnabled = true;
        /** When {@code false}, registered {@link io.github.engahmedatef.fcm.spi.FcmMessageEnricher} beans are bypassed. Default: {@code true}. */
