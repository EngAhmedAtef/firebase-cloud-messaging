package io.github.engahmedatef.fcm.integration;
...
class RetryIT {
    ...
    void networkFault_wrapsAsFcmTransportException_notRetried() {
        ...
        StepVerifier.create(client.sendToDevice(FcmTestFixtures.aDevice(), FcmTestFixtures.aDeviceMessage()))
                .expectError(io.github.engahmedatef.fcm.exception.FcmTransportException.class)
    ...
    void allRetriesExhausted_propagatesLastError() {
        ...
        StepVerifier.create(client.sendToDevice(FcmTestFixtures.aDevice(), FcmTestFixtures.aDeviceMessage()))
                .expectError(io.github.engahmedatef.fcm.exception.FcmInternalException.class)
    ...
    void nonRetryableError_failsImmediately_noRetries() {
        ...
        StepVerifier.create(client.sendToDevice(FcmTestFixtures.aDevice(), FcmTestFixtures.aDeviceMessage()))
                .expectError(io.github.engahmedatef.fcm.exception.FcmInvalidRequestException.class)
                .verify(Duration.ofSeconds(5));
