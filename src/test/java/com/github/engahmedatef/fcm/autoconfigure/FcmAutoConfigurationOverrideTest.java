...
class FcmAutoConfigurationOverrideTest {
    ...
    void validationDisabledMakesChainSkipValidators() {
        contextRunner
                .withPropertyValues("com.github.engahmedatef.fcm.validation.enabled=false")
                .run(ctx -> {
    ...
    void correlationDisabledContextStillLoads() {
        contextRunner
                .withPropertyValues("com.github.engahmedatef.fcm.observability.correlation-enabled=false")
    ...
    void tracingDisabledContextStillLoads() {
        contextRunner
                .withPropertyValues("com.github.engahmedatef.fcm.observability.tracing-enabled=false")
                .run(ctx -> assertThat(ctx).hasSingleBean(ReactiveFcmClient.class));
    }
}
